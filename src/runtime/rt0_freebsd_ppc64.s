...
TEXT _rt0_ppc64_freebsd_lib(SB),NOSPLIT,$-8
	...
	MOVD	R3, _rt0_ppc64_freebsd_lib_argc<>(SB)
	MOVD	R4, _rt0_ppc64_freebsd_lib_argv<>(SB)
	...
	CMP	$0, R12
	BEQ	nocgo
	MOVD	$_rt0_ppc64_freebsd_lib_go(SB), R3
	MOVD	$0, R4
	MOVD	R12, CTR
	BL	(CTR)
	BR	done
...
nocgo:
	...
	MOVD	R12, 8(R1)
	MOVD	$_rt0_ppc64_freebsd_lib_go(SB), R12
	MOVD	R12, 16(R1)
...
TEXT _rt0_ppc64_freebsd_lib_go(SB),NOSPLIT,$0
	MOVD	_rt0_ppc64_freebsd_lib_argc<>(SB), R3
	MOVD	_rt0_ppc64_freebsd_lib_argv<>(SB), R4
	MOVD	$runtime·rt0_go(SB), R12
	MOVD	R12, CTR
	BR	(CTR)

DATA _rt0_ppc64_freebsd_lib_argc<>(SB)/8, $0
GLOBL _rt0_ppc64_freebsd_lib_argc<>(SB),NOPTR, $8
DATA _rt0_ppc64_freebsd_lib_argv<>(SB)/8, $0
GLOBL _rt0_ppc64_freebsd_lib_argv<>(SB),NOPTR, $8
